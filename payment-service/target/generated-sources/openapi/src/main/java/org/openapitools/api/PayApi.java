...
import org.openapitools.model.PaymentDto;
...
public interface PayApi {
    ...
    /**
     * POST /pay : Провести платеж
     *
     * @param paymentDto  (required)
     * @return Платеж прошел (status code 200)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Платеж прошел"),
    ...
    Mono<ResponseEntity<Void>> performPayment(
